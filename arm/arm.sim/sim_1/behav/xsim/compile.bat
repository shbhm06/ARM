...
REM
REM Generated by Vivado on Wed Feb 18 08:59:40 +0530 2026
...
echo "xvlog --incr --relax -prj tb_cnn_vlog.prj"
call xvlog  --incr --relax -prj tb_cnn_vlog.prj -log xvlog.log
